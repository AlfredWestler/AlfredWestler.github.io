...
document.getElementById("church-maps-frame").src = churchUrl;
document.getElementById("event-maps-frame").src = eventUrl;
document.getElementById("example_map").src = churchUrl;